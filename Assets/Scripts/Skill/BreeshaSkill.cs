...
public class BreeshaSkill : MonoBehaviour
{
    ...
    [SerializeField] private GameObject _skill3Effect2;
    [SerializeField] private GameObject _skill4Effect;
    ...
    IEnumerator Skill4()
    {
        _Drone.localRotation = Quaternion.Euler(-70,0,0);
        _Drone2.localRotation = Quaternion.Euler(-70, 0, 0);
        yield return new WaitForSeconds(0.2f);
        activebeam = true;
        yield return new WaitForSeconds(0.2f);
        _skill4Effect.SetActive(true);
        yield return new WaitForSeconds(1.5f);
        activebeam = false;
        _skill4Effect.SetActive(false);
    }
}
